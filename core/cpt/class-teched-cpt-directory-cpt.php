...
class CPT_TechEd_CPT_Directory extends RBM_CPT {
	...
	public function register_taxonomy() {
        ...
        $args = array(
            'hierarchical'          => true,
            'labels'                => $this->get_taxonomy_labels( __( 'Directory Category', 'teched-cpt-directory' ), __( 'Directory Categories', 'teched-cpt-directory' ) ),
            'show_in_menu'          => true,
            'show_ui'               => true,
            'show_admin_column'     => true,
            'update_count_callback' => '_update_post_term_count',
        ...
        $args = array(
            'hierarchical'          => false,
            'labels'                => $this->get_taxonomy_labels( __( 'Directory Tag', 'teched-cpt-directory' ), __( 'Directory Tags', 'teched-cpt-directory' ) ),
            'show_in_menu'          => true,
            'show_ui'               => true,
            'show_admin_column'     => true,
            'update_count_callback' => '_update_post_term_count',
